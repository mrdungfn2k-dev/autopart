                ...
                <input
                  ...
                  onKeyDown={e => {
                    if (e.key === "Enter" && newsletter.includes("@")) {
                      const subs: string[] = JSON.parse(localStorage.getItem("ap_newsletter") || "[]");
                      if (!subs.includes(newsletter)) localStorage.setItem("ap_newsletter", JSON.stringify([...subs, newsletter]));
