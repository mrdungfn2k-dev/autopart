      ...
      <div className="ap-container h-[54px] relative flex items-center justify-between">
        ...
        <div className="flex items-center shrink-0 z-10 pl-4 gap-[16px]">
          <Link href="/cart" className="relative cursor-pointer hover:opacity-80 transition-opacity">
            <ShoppingCart size={24} className="text-[#44494d]" />
            {count > 0 && (
              <span className="absolute -top-[4px] -right-[6px] bg-[#EF4444] text-white text-[10px] font-bold min-w-[18px] h-[18px] flex items-center justify-center rounded-full border border-white px-[4px]">
                {count > 99 ? '99+' : count}
              </span>
            )}
          </Link>
