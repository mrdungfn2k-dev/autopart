        ...
        <div className="bg-white rounded-2xl border border-[#f0f0f0] p-6 mt-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              { icon: "📞", title: "Hotline", desc: "1900 8095", action: lang === "zh" ? "现在拨打" : "Gọi ngay" },
              {
                icon: "✉️",
                title: "Email",
              ...
              <div key={c.title} className="text-center p-5 rounded-2xl border-2 border-[#f0f0f0] hover:border-[#1a4b97]/30 transition-all">
                ...
                <button className="px-4 py-2 rounded-xl text-sm font-bold text-white" style={{ background: "var(--ap-primary)" }}>
                  {c.action}
                </button>
              </div>
            ))}
