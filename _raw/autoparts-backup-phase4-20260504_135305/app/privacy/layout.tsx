...
export async function generateMetadata(): Promise<Metadata> {
  const fallbackTitle = 'Chính sách bảo mật';
  const fallbackDesc = 'Cam kết bảo mật và xử lý dữ liệu cá nhân khách hàng tại AutoParts.';
  try {
    const settings = readJson<any>("settings.json") || {};
    const meta = settings?.seoMeta?.['privacy'];
    return {
