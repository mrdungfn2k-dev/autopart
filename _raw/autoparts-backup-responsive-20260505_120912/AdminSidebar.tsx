...
export default function AdminSidebar({
 active = "/admin" }: { active?: string }) {
  ...
  const menuItems = [
    ...
    { label: "Từ đồng nghĩa", href: "/admin/search-synonyms",
    ...
    { label: "Bộ thuộc tính", href: "/admin/attribute-sets",
    ...
    { label: "Kho hàng & Nguồn", href: "/admin/warehouses",
      icon: "M22 21V7L12 3 2 7v14h5v-9h10v9h5z" },
    { label: "Kênh bán", href: "/admin/channels",
