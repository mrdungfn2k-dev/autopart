...
function VouchersTab() {
  ...
  const create = async () => {
    ...
    setSaving(true);
    try {
      await vouchersApi.create({ ...form, type: form.type as "percent" | "fixed" | "shipping", value: Number(form.value), minOrder: Number(form.minOrder), limit: Number(form.limit), minQty: Number(form.minQty) || 0 } as any);
      setShowModal(false);
      setForm({ code: "", type: "percent", value: "", minOrder: "", limit: "100", expiry: "", minQty: "0", applicableCategoryIds: [], applicableProductIds: [] });
      load();
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md">
            ...
            <div className="p-5 space-y-4">
              ...
              {/* Phase 4.1: Quy tắc danh mục — chỉ áp dụng cho danh mục cụ thể */}
