...
export default function CartPage() {
  ...
  // Xóa đã chọn — chỉ xóa items đang được check (Shopee-style)
  ...
  return (
    <div className="min-h-screen" style={{ background: "#f8f8fa" }}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {!canBuy && (
          <div className="mb-4 p-4 rounded-xl border-2 border-amber-300 bg-amber-50 flex items-start gap-3">
