...
const DEFAULTS: Record<string, unknown> = {
  ...
  footer: {
    ...
    phone: "19008095",
    newsletterTitle: "Đăng ký nhận khuyến mãi",
    newsletterSubtitle: "Nhận Flash Sale & ưu đãi độc quyền sớm nhất",
    newsletterPromo: "Mã GIAMGIA10 — giảm 10% cho đơn đầu tiên",
    socialLinks: [
  ...
  payment: {
    qrImage: "",              // ảnh QR thật do admin tải lên (data URL hoặc URL)
    bankName: "Vietcombank",
    bankAccount: "0011004095896",
