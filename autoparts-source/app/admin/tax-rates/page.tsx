...
const TITLE = "Loại thuế";
const SLUG = "tax-rates";
const FIELDS = [
    { key: "name", label: "Tên thuế", type: "text", required: true, placeholder: "VAT 10%" },
    { key: "rate", label: "Thuế suất (%)", type: "number", step: "0.1", required: true },
    { key: "isDefault", label: "Mặc định toàn site", type: "boolean" },
    { key: "categoryIds", label: "Áp dụng danh mục (id, mỗi dòng 1 cái)", type: "array" },
  ];
