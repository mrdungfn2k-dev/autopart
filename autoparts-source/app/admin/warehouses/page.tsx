...
const TITLE = "Kho hÃ ng";
const SLUG = "warehouses";
const FIELDS = [
    { key: "code", label: "MÃ£ kho", type: "text", required: true, placeholder: "HN" },
    { key: "name", label: "TÃªn kho", type: "text", required: true },
    { key: "city", label: "ThÃ nh phá»‘", type: "text" },
    { key: "address", label: "Äá»‹a chá»‰", type: "text" },
    { key: "isDefault", label: "Kho máº·c Ä‘á»‹nh", type: "boolean" },
