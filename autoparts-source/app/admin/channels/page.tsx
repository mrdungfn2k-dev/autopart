...
const TITLE = "Kênh bán";
const SLUG = "channels";
const FIELDS = [
    { key: "code", label: "Mã", type: "text", required: true, placeholder: "shopee" },
    { key: "name", label: "Tên kênh", type: "text", required: true },
    { key: "type", label: "Loại kênh", type: "select", options: [
      { value: "web", label: "Web (storefront)" },
      { value: "marketplace", label: "Sàn TMĐT" },
      { value: "social", label: "Mạng xã hội" },
      { value: "pos", label: "Cửa hàng vật lý (POS)" },
    ] },
    { key: "url", label: "URL", type: "text", placeholder: "https://..." },
    { key: "isDefault", label: "Kênh mặc định", type: "boolean" },
