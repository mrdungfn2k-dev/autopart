...
const dict = {
 vi: {
  ...
  tier1Price: "Giá đại lý (Tier 1)", discount17: "giảm 17%", returns: "Đổi trả", delivery: "Giao hàng", "7days": "7 ngày", "2_4days": "2-4 ngày", remaining: "Còn lại", items: "sản phẩm",
  genericParts: "Phổ thông",
  // Admin sidebar
  adminDashboard: "Bảng điều khiển", adminUsers: "Đối tác & Khách hàng",
  adminCatalog: "Sản phẩm & Danh mục", adminOrders: "Đơn hàng",
  ...
  // Admin sidebar (mục mới — trước hardcode tiếng Việt)
  adminSuppliers: "Nhà cung cấp", adminMessages: "Tin nhắn", adminVehicles: "Hãng xe & VIN",
  adminCms: "CMS Nội dung", adminSynonyms: "Từ đồng nghĩa", adminImportExport: "Nhập / Xuất dữ liệu",
  adminNewsletter: "Bản tin", adminAttributeSets: "Bộ thuộc tính", adminInvoices: "Hóa đơn",
  adminTransactions: "Giao dịch", adminRefunds: "Hoàn tiền", adminCarriers: "Vận chuyển",
  adminTaxRates: "Loại thuế", adminWarehouses: "Kho hàng & Nguồn", adminChannels: "Kênh bán",
  adminProfile: "Hồ sơ cá nhân", adminSuspensions: "Yêu cầu tạm ngưng",
  // Profile pages (4 phân quyền)
  accountProfileTitle: "Hồ sơ tài khoản", saveChanges: "Lưu thay đổi", savedShort: "✓ Đã lưu!",
  basicInfo: "Thông tin cơ bản", roleLabel: "Phân quyền",
  distributionChannel: "Kênh phân phối chính", selfIntro: "Giới thiệu bản thân",
  // Admin transactions page
  txTypePayment: "Thanh toán", txTypeRefund: "Hoàn tiền", txTypeAdjustment: "Điều chỉnh",
  txMethodQr: "Chuyển khoản QR", txMethodCod: "Khi nhận hàng (COD)", txMethodMomo: "Ví MoMo",
  txMethodBank: "Chuyển khoản", txMethodCard: "Thẻ",
  txStatusPending: "Chờ xử lý", txStatusSuccess: "Thành công", txStatusFailed: "Thất bại",
  txStatusCancelled: "Đã hủy", txStatusRefunded: "Đã hoàn tiền",
  txAllTypes: "Tất cả loại", txLoading: "Đang tải...", txEmpty: "Chưa có giao dịch",
  txEmptyHint: "Giao dịch sẽ được ghi tự động khi tạo đơn hàng.",
  txColOrder: "Đơn hàng", txColType: "Loại", txColMethod: "Phương thức", txColAmount: "Số tiền",
  txColStatus: "Trạng thái", txColTime: "Thời gian",
  // Admin content
  ...
  home: "Trang chủ", specs: "Thông số kỹ thuật", origin: "Xuất xứ", stockStatus: "Tình trạng kho", originalOEM: "OEM chính hãng", itemsAvailable: "sản phẩm có sẵn", reviewsTab: "Đánh giá", notUpdated: "Chưa cập nhật", noReviewsYet: "Chưa có đánh giá",
  allProducts: "Tất cả sản phẩm", aftermarketOES: "Aftermarket / OES", verifiedBuyer: "Người mua đã xác minh", compatibleWithFollowing: "Tương thích với các xe sau", loadingProductInfo: "Đang tải thông tin sản phẩm...", "2_4days": "2–4 ngày", "7days": "7 ngày", favorite: "Yêu thích", share: "Chia sẻ",
  analyticsAndReports: "Phân tích & Báo cáo", analyticsDesc: "Thống kê doanh thu, sản phẩm và khách hàng", exportReport: "Tải báo cáo", revenueByDay: "Doanh thu theo ngày", top5SellingProducts: "Top 5 sản phẩm bán chạy", conversionRate6Months: "Tỉ lệ chuyển đổi 6 tháng", byCategory: "Theo danh mục", averageRating: "Đánh giá trung bình", successfulOrders: "Đơn thành công", ordersCount: "Số đơn", vsLastMonth: "so với tháng trước", stable: "Ổn định",
  noOrders: "Chưa có đơn hàng", orderCode: "Mã đơn hàng", orderPending: "Chờ xác nhận", orderConfirmed: "Đã xác nhận", orderShipping: "Đang giao", orderDelivered: "Đã giao", confirmDelivered: "Xác nhận đã giao", confirmStockIn: "Xác nhận nhập kho", stockInQty: "Số lượng nhập", statusUpdated: "Đã cập nhật trạng thái", updateFailed: "Cập nhật thất bại",
  trackOrderDesc: "Nhập mã đơn hàng để xem trạng thái vận chuyển và thông tin giao hàng của bạn.",
  enterOrderCodeToTrack: "Nhập mã đơn hàng phía trên để theo dõi hành trình giao hàng.",
 ...
 en: {
  // Nav
  products: "Products", flashSale: "Flash Sale", vin: "VIN Lookup", login: "Log in", logout: "Log out",
  register: "Sign up", cart: "Cart", search: "Search", searchBtn: "Search",
  searchPlaceholder: "Search parts (e.g. Brake pads, Oil filter...)",
  vinPlaceholder: "Enter 17-character VIN (e.g. 1HGBH41JXMN109186)", vinBtn: "Look up",
  // Homepage
  findByVehicle: "Find parts for your vehicle", selectBrand: "Select brand",
  selectModel: "Select model", selectYear: "Select year", findParts: "Find parts",
  vinQuickSearch: "Quick VIN lookup", heroTitle1: "Genuine Auto Parts", heroTitle2: "Trusted Nationwide",
  heroDesc: "A digital auto-parts supply-chain platform - from supplier warehouse to mechanics and car owners, with full transparency on origin, price and warranty.",
  shopNow: "Shop now", viewFlashSale: "View Flash Sale", categoryTitle: "Product categories",
  categorySubtitle: "Find exactly the parts your car needs", flashSaleEnds: "Ends in:",
  addToCart: "Add to cart", featuredProducts: "Featured products",
  featuredSubtitle: "Best-selling genuine parts this month", whyChooseUs: "Why choose AutoParts?",
  proSeries: "PRO SERIES", itemCount: "items",
  // Common UI
  viewAll: "View all", close: "Close", save: "Save", cancel: "Cancel", confirm: "Confirm",
  submit: "Submit", back: "Back", next: "Next", loading: "Loading...",
  add: "Add", edit: "Edit", delete: "Delete", filter: "Filter", export: "Export",
  status: "Status", action: "Action", price: "Price", total: "Total",
  quantity: "Quantity", order: "Order", orders: "Orders", product: "Product",
  customer: "Customer", date: "Date", note: "Note", payment: "Payment",
  shipping: "Shipping", warranty: "Warranty", discount: "Discount", stock: "Stock",
  brand: "Brand", category: "Category", description: "Description", rating: "Rating", review: "Review",
  all: "All", detail: "Detail", update: "Update", create: "Create",
  noData: "No data", searchGeneric: "Search...",
  showing: "Showing", of: "of", page: "Page", previous: "Previous",
  active: "Active", inactive: "Inactive", enable: "Enable", disable: "Disable",
  yes: "Yes", no: "No", success: "Success", error: "Error", warning: "Warning", info: "Info",
  // Login
  loginTitle: "Log in", loginSubtitle: "Welcome back! Please enter your account details.",
  loginWelcome: "Welcome back",
  emailLabel: "Email / Phone", emailPlaceholder: "your@email.com or phone number",
  passwordLabel: "Password", forgotPassword: "Forgot password?", rememberMe: "Remember me",
  loginBtn: "Log in", orContinueWith: "Or continue with",
  noAccount: "Don't have an account?", registerNow: "Sign up now",
  demoAccounts: "Demo accounts:", showPassword: "Show", hidePassword: "Hide", email: "Email",
  // Register
  registerTitle: "Create a new account", registerSubtitle: "Join Vietnam's leading auto-parts platform",
  fullName: "Full name", fullNamePlaceholder: "John Smith",
  phone: "Phone", phonePlaceholder: "0901234567",
  passwordConfirm: "Confirm password", selectRole: "Select account type",
  roleCustomer: "Customer", roleSupplier: "Supplier", roleAffiliate: "Affiliate",
  agreeTerms: "I agree to the", termsOfService: "Terms of Service",
  and: "and", privacyPolicy: "Privacy Policy",
  registerBtn: "Create account", haveAccount: "Already have an account?", loginNow: "Log in now",
  // Generic UI utilities
  save: "Save", saveBtn: "Save", cancel: "Cancel", edit: "Edit", delete: "Delete", confirm: "Confirm",
  note: "Note", noData: "No data", addToCart: "Add to cart",
  // Cart/Checkout
  cartTitle: "Your cart", cartEmpty: "Your cart is empty",
  cartContinueShopping: "Continue shopping", cartCheckout: "Checkout",
  cartSubtotal: "Subtotal", cartShipping: "Shipping", cartTotal: "Total",
  cartFreeShipping: "Free", cartRemove: "Remove",
  checkoutTitle: "Checkout", shippingInfo: "Shipping details",
  paymentMethod: "Payment method", orderSummary: "Order summary",
  placeOrder: "Place order", cod: "Cash on delivery",
  bankTransfer: "Bank transfer", eWallet: "E-wallet",
  address: "Address", city: "City", district: "District", ward: "Ward",
  addressDetail: "House number, street name", voucherCode: "Voucher code", apply: "Apply",
  // Products
  productsTitle: "Parts catalog", productsSortBy: "Sort by", productsFilter: "Filter products",
  productsInStock: "In stock", productsAll: "All", productsNoResult: "No products found",
  productsAddCart: "Add to cart", productsBuyNow: "Buy now",
  productsOriginalPrice: "List price", productsYourPrice: "Your price",
  productDetail: "Product details", specifications: "Specifications",
  compatibility: "Compatible vehicles", reviews: "Reviews", relatedProducts: "Related products",
  oemCode: "OEM code", inStock: "In stock", outOfStock: "Out of stock", sold: "Sold",
  tier1Price: "Tier 1 price", discount17: "17% off", returns: "Returns", delivery: "Delivery", "7days": "7 days", "2_4days": "2-4 days", remaining: "Remaining", items: "items",
  genericParts: "Generic parts",
  // Admin sidebar
  adminDashboard: "Dashboard", adminUsers: "Partners & Customers",
  adminCatalog: "Products & Categories", adminOrders: "Orders",
  adminFinance: "Finance & Commission", adminMarketing: "Marketing & Vouchers",
  adminApprovals: "Approvals", adminReports: "Reports", adminSettings: "System settings",
  groupManage: "Manage", groupOperations: "Operations",
  adminSuppliers: "Suppliers", adminMessages: "Messages", adminVehicles: "Vehicles & VIN",
  adminCms: "Content CMS", adminSynonyms: "Synonyms", adminImportExport: "Import / Export",
  adminNewsletter: "Newsletter", adminAttributeSets: "Attribute sets", adminInvoices: "Invoices",
  adminTransactions: "Transactions", adminRefunds: "Refunds", adminCarriers: "Shipping",
  adminTaxRates: "Tax rates", adminWarehouses: "Warehouses & Sources", adminChannels: "Sales channels",
  adminProfile: "Profile", adminSuspensions: "Suspend requests",
  accountProfileTitle: "Account profile", saveChanges: "Save changes", savedShort: "✓ Saved!",
  basicInfo: "Basic information", roleLabel: "Role",
  distributionChannel: "Main distribution channel", selfIntro: "About you",
  txTypePayment: "Payment", txTypeRefund: "Refund", txTypeAdjustment: "Adjustment",
  txMethodQr: "QR transfer", txMethodCod: "Cash on delivery (COD)", txMethodMomo: "MoMo wallet",
  txMethodBank: "Bank transfer", txMethodCard: "Card",
  txStatusPending: "Pending", txStatusSuccess: "Success", txStatusFailed: "Failed",
  txStatusCancelled: "Cancelled", txStatusRefunded: "Refunded",
  txAllTypes: "All types", txLoading: "Loading...", txEmpty: "No transactions",
  txEmptyHint: "Transactions are recorded automatically when orders are created.",
  txColOrder: "Order", txColType: "Type", txColMethod: "Method", txColAmount: "Amount",
  txColStatus: "Status", txColTime: "Time",
  // Admin content
  dashboardTitle: "Dashboard", totalRevenue: "Total revenue",
  totalOrders: "Total orders", totalProducts: "Total products", totalUsers: "Total users",
  newOrders: "New orders", pendingApprovals: "Pending approvals", monthlyRevenue: "Monthly revenue",
  recentOrders: "Recent orders", topProducts: "Top products",
  systemOverview: "System overview", quickActions: "Quick actions",
  viewAllOrders: "View all orders", growth: "Growth", comparedLastMonth: "vs last month",
  today: "Today", thisWeek: "This week", thisMonth: "This month", thisYear: "This year",
  // Admin Users
  usersTitle: "Manage Partners & Customers", addUser: "Add user",
  userName: "Name", userEmail: "Email", userRole: "Role", userStatus: "Status",
  userJoined: "Joined", userActions: "Actions", editUser: "Edit user",
  deleteUser: "Delete user", confirmDelete: "Are you sure you want to delete?",
  roleAdmin: "Admin", roleSupplier2: "Supplier", roleCustomer2: "Customer",
  roleAffiliate2: "Affiliate", manageRoles: "Manage roles",
  roleName: "Role name", roleColor: "Color", searchUsers: "Search by name, email...",
  verified: "Verified", unverified: "Unverified",
  // Admin Catalog
  catalogTitle: "Categories & Parts", addProduct: "Add product",
  categoryName: "Category name", productName: "Product name", productPrice: "Price",
  productStock: "Stock", productType: "Type", productBrand: "Brand",
  productCategory: "Category", searchProducts: "Search products...",
  allCategories: "All categories", allTypes: "All types",
  // Admin Orders
  ordersTitle: "Order management", orderDate: "Order date", orderCustomer: "Customer",
  orderTotal: "Total", orderStatus: "Status", orderDetail: "Order details",
  orderId: "Order ID", orderItems: "Items", shippingAddress: "Shipping address",
  trackingNumber: "Tracking number", statusPending: "Pending", statusConfirmed: "Confirmed",
  statusShipping: "Shipping", statusDelivered: "Delivered", statusCancelled: "Cancelled",
  statusReturned: "Returned", searchOrders: "Search orders...", allStatuses: "All statuses",
  exportExcel: "Export Excel", totalAmount: "Items total", shippingFee: "Shipping fee",
  discountAmount: "Discount", finalTotal: "Amount payable",
  // Admin Finance
  financeTitle: "Finance & Commission", revenue: "Revenue", commission: "Commission",
  profit: "Profit", payout: "Payout", pendingPayout: "Pending payout",
  completedPayout: "Paid out", transactionHistory: "Transaction history",
  transactionDate: "Date", transactionType: "Type", transactionAmount: "Amount",
  transactionStatus: "Status", withdrawRequest: "Withdrawal request",
  // Supplier Settings
  storeInfo: "Store information", storeName: "Store name",
  taxCode: "Tax code", warehouseAddress: "Warehouse address",
  currentPlatformFee: "Current platform fee", agreedWithPlatform: "Agreed with platform",
  ofTotalGMV: "of total GMV",
  automatedOperations: "Automated operations",
  autoConfirmOrder: "Auto-confirm orders", autoConfirmOrderDesc: "System auto-reviews orders after customer payment",
  autoUpdateShipping: "Auto-update shipping", autoUpdateShippingDesc: "Automatically sync carrier partner status",
  sameDayDelivery: "Same-day delivery", sameDayDeliveryDesc: "Applies to same-province orders",
  notifications: "Notifications",
  newOrder: "New order alert", newOrderDesc: "Get notified when there's a new order",
  lowStockWarn: "Low stock warning", lowStockWarnDesc: "Alert when stock falls below minimum",
  payoutAlert: "Payout alert", payoutAlertDesc: "Notify when receiving a platform payout",
  productGotReview: "Product got a review", productGotReviewDesc: "Notify instantly when a customer leaves a review",
  flashSalePromo: "Flash sale campaign", flashSalePromoDesc: "Alert when invited to a major promotion",
  suspendOperations: "Suspend operations", suspendOperationsDesc: "Your store will be temporarily hidden and customers cannot order.",
  requestSuspendStore: "Request suspension", savedSuccess: "Saved successfully!",
  // Admin Marketing
  marketingTitle: "Marketing & Vouchers", createVoucher: "Create voucher",
  voucherCodeLabel: "Voucher code", voucherType: "Type", voucherValue: "Value",
  voucherMinOrder: "Min. order", voucherUsed: "Used", voucherLimit: "Limit",
  voucherExpiry: "Expiry", voucherStatus: "Status", voucherActions: "Actions",
  typePercent: "Percentage", typeFixed: "Fixed amount", typeFreeShipping: "Free shipping",
  searchVoucher: "Search voucher code...", promoCode: "Promo code", bannerAds: "Banner ads",
  flashSaleManage: "Flash Sale", createFlashSale: "Create flash sale",
  campaignName: "Campaign name", discountPercent: "Discount (%)",
  startTime: "Start time", endTime: "End time",
  selectProductsLabel: "Select products", selected: "Selected",
  scheduleFlashSale: "Schedule flash sale", running: "Running", scheduled: "Scheduled",
  ended: "Ended", addBanner: "Add banner", bannerTitle: "Title",
  bannerSubtitle: "Subtitle", bannerCTA: "CTA button", bannerLink: "Link",
  bannerStartDate: "Start date", bannerEndDate: "End date", clicks: "Clicks",
  deleteVoucher: "Delete this voucher?", deleteFlashSale: "Delete this campaign?",
  deleteBanner: "Delete this banner?", createVoucherTitle: "Create new voucher",
  fillRequired: "Please fill in all required fields", saving: "Saving...",
  discountType: "Discount type", valueStar: "Value *",
  minOrderLabel: "Min. order", usageLimit: "Usage limit", expiryDate: "Expiry date",
  createBanner: "Create banner", freeShip: "Free shipping",
  // Admin Approvals
  approvalsTitle: "Approval management", approve: "Approve", reject: "Reject",
  pendingReview: "Pending review", approved: "Approved", rejected: "Rejected",
  supplierApproval: "Supplier approval", productApproval: "Product approval",
  requestDate: "Request date", reviewNote: "Review note",
  // Admin Reports
  reportsTitle: "Reports center", salesReport: "Sales report", revenueReport: "Revenue report",
  productReport: "Product report", userReport: "User report",
  exportPDF: "Export PDF", exportCSV: "Export CSV", dateRange: "Date range",
  from: "From", to: "To", chart: "Chart", table: "Table",
  // Admin Settings
  settingsTitle: "System settings", generalSettings: "General settings",
  siteName: "Site name", siteDescription: "Site description",
  contactEmail: "Contact email", contactPhone: "Contact phone", socialMedia: "Social media",
  shippingSettings: "Shipping settings", paymentSettings: "Payment settings",
  notificationSettings: "Notification settings", securitySettings: "Security settings", saveSettings: "Save settings",
  // Supplier sidebar
  supplierDashboard: "Dashboard", supplierOrders: "Orders", supplierProducts: "Products",
  supplierInventory: "Inventory", supplierFinance: "Finance", supplierSettings: "Settings",
  groupMain: "Main",
  // Supplier content
  supplierDashTitle: "Supplier overview", pendingOrders: "Pending",
  processingOrders: "Processing", completedOrders: "Completed", cancelledOrders: "Cancelled",
  lowStock: "Low stock", monthlyIncome: "Monthly income", ordersToday: "Orders today",
  productsActive: "Active products", manageProducts: "Manage products",
  addNewProduct: "Add product", productImage: "Product image",
  dragDropImage: "Drag & drop or click to choose image", imageFormat: "JPG, PNG, WEBP - max 5MB",
  removeImage: "Remove image", productNameLabel: "Product name *", oemCodeLabel: "OEM code *",
  priceLabel: "Price *", stockLabel: "Stock quantity *", categoryLabel: "Category",
  typeLabel: "Type", compatibleVehicles: "Compatible vehicles (one per line)",
  saveProduct: "Save product", onSale: "On sale", hidden: "Hidden", view: "View",
  // Supplier Orders
  supplierOrderTitle: "Order management",
  advanceStatus: "Advance status", saveTracking: "Save tracking number",
  noOrderSelected: "Select an order to view details", orderInfo: "Order information",
  // Supplier Inventory
  inventoryTitle: "Inventory management", warehouseName: "Warehouse name",
  stockIn: "Stock in", stockOut: "Stock out", adjustStock: "Adjust",
  currentStock: "Current stock", minStock: "Min. stock",
  stockAlert: "Stock alert", importHistory: "Stock movement history",
  // Supplier Finance
  supplierFinanceTitle: "Supplier finance", availableBalance: "Available balance",
  totalSales: "Total sales", pendingPayment: "Pending settlement", withdrawMoney: "Withdraw",
  // Supplier Analytics
  analyticsTitle: "Analytics & stats", salesChart: "Sales chart",
  topSellingProducts: "Top-selling products", revenueByCategory: "Revenue by category",
  orderTrend: "Order trend",
  // Affiliate sidebar
  affiliateDashboard: "Dashboard", affiliateLinks: "Referral links",
  affiliateTeam: "Team", affiliateCommissions: "Commission",
  affiliateWithdraw: "Withdraw", affiliateSettings: "Settings",
  // Affiliate content
  affiliateDashTitle: "Affiliate overview", totalCommission: "Total commission",
  pendingCommission: "Pending", paidCommission: "Paid",
  totalClicks: "Total clicks", totalConversions: "Total conversions",
  conversionRate: "Conversion rate", myLinks: "My links", createLink: "Create link",
  linkURL: "Link URL", linkClicks: "Clicks", linkOrders: "Orders",
  linkCommission: "Commission", copyLink: "Copy", shareLink: "Share",
  teamMembers: "Team members", inviteTeam: "Invite",
  memberName: "Name", memberJoined: "Joined", memberOrders: "Orders",
  memberCommission: "Commission", commissionHistory: "Commission history",
  withdrawHistory: "Withdrawal history", withdrawAmount: "Withdrawal amount",
  bankAccount: "Bank account", bankName: "Bank name",
  accountNumber: "Account number", accountHolder: "Account holder",
  requestWithdraw: "Request withdrawal",
  // Customer sidebar
  customerDashboard: "Overview", customerOrders: "My orders", customerGarage: "My garage",
  customerRewards: "Rewards", customerWarranty: "Warranty",
  customerProfile: "Profile", customerSettings: "Settings",
  // Customer content
  customerDashTitle: "Customer overview", myOrders: "My orders",
  recentPurchases: "Recent purchases", totalSpent: "Total spent",
  rewardPoints: "Reward points", pointsAvailable: "Available points",
  pointsUsed: "Used points", pointsEarned: "Earned points", redeemPoints: "Redeem points",
  myGarage: "My garage", addVehicle: "Add vehicle", vehicleBrand: "Brand",
  vehicleModel: "Model", vehicleYear: "Year", vehiclePlate: "License plate",
  vehicleVIN: "VIN", warrantyTitle: "Warranty management", warrantyProduct: "Product",
  warrantyStartDate: "Start date", warrantyEndDate: "Expiry date",
  warrantyStatus: "Status", warrantyClaim: "Claim warranty",
  profileTitle: "Profile", personalInfo: "Personal information",
  changePassword: "Change password", currentPassword: "Current password",
  newPassword: "New password", confirmNewPassword: "Confirm new password",
  // Settings shared
  settingLanguage: "Language", settingNotification: "Notifications",
  settingPrivacy: "Privacy", settingAccount: "Account",
  deleteAccount: "Delete account", settingSaved: "Settings saved",
  // About
  aboutTitle: "About AutoParts", aboutDesc: "Vietnam's leading online auto-parts platform",
  ourMission: "Our mission", ourVision: "Our vision", ourTeam: "Our team", contactUs: "Contact us",
  // Help
  helpTitle: "Help center", faq: "FAQ",
  contactSupport: "Contact support", guides: "Guides", askQuestion: "How can we help?",
  // Tracking
  trackingTitle: "Order tracking", enterOrderId: "Enter order ID",
  trackBtn: "Track", trackingResult: "Result", shipmentStatus: "Shipment status",
  trackOrder: "Track order",
  home: "Home", specs: "Specifications", origin: "Origin", stockStatus: "Stock status", originalOEM: "Original OEM", itemsAvailable: "items available", reviewsTab: "Reviews", notUpdated: "Not updated", noReviewsYet: "No reviews yet",
  allProducts: "All products", aftermarketOES: "Aftermarket / OES", verifiedBuyer: "Verified buyer", compatibleWithFollowing: "Compatible with the following", loadingProductInfo: "Loading product info...", "2_4days": "2–4 days", "7days": "7 days", favorite: "Favorite", share: "Share",
  analyticsAndReports: "Analytics & Reports", analyticsDesc: "Revenue, product and customer statistics", exportReport: "Export report", revenueByDay: "Revenue by day", top5SellingProducts: "Top 5 selling products", conversionRate6Months: "6-month conversion rate", byCategory: "By category", averageRating: "Average rating", successfulOrders: "Successful orders", ordersCount: "Orders", vsLastMonth: "vs last month", stable: "Stable",
  noOrders: "No orders", orderCode: "Order code", orderPending: "Pending", orderConfirmed: "Confirmed", orderShipping: "Shipping", orderDelivered: "Delivered", confirmDelivered: "Confirm delivered", confirmStockIn: "Confirm stock-in", stockInQty: "Stock-in quantity", statusUpdated: "Status updated", updateFailed: "Update failed",
  trackOrderDesc: "Enter your order ID to see delivery status and shipping details.",
  enterOrderCodeToTrack: "Enter an order ID above to track its delivery journey.",
  orderCodePlaceholder: "Enter order ID (e.g. AP-2024-001)...",
  lookUp: "Look up",
  orderNotFound: "Order not found, please check the order ID.",
  systemError: "System error, please try again later.",
  orderSuccess: "Order placed",
  supplierConfirmed: "Supplier confirmed",
  packing: "Packing",
  handedOver: "Handed to carrier",
  delivered: "Delivered",
  orderCancelled: "Order cancelled",
  orderJourney: "Order progress",
  trackingCode: "Tracking number",
  current: "Current",
  // VIN
  vinLookupTitle: "VIN Lookup",
  vinLookupDesc: "Enter a 17-character VIN to find vehicle info and compatible parts",
  vinResult: "Result", vehicleInfo: "Vehicle information", compatibleParts: "Compatible parts",
  // Payment
  paymentSuccess: "Payment successful!", paymentSuccessDesc: "Thank you for your purchase, your order is being processed.",
  paymentFail: "Payment failed", paymentFailDesc: "An error occurred during payment, please try again.",
  returnHome: "Back to home", retryPayment: "Retry", viewOrder: "View order",
  // Flash Sale
  flashSaleTitle: "Flash Sale", flashSaleCountdown: "Ends in",
  hours: "h", minutes: "m", seconds: "s",
  // System
  dropshippingSystem: "Dropshipping system", supplierGold: "Gold supplier",
  checkingLogin: "Checking login...", accessDenied: "Access denied",
  accessDeniedDesc: "Your account does not have permission to access this page.",
  loginAgain: "Log in again", goHome: "Back to home",
  // Homepage features
  featureOEM: "Genuine OEM & OES parts", featureFlashSale: "Daily deals up to 40% off",
  featureVIN: "Smart VIN matching", featureWarranty: "Nationwide warranty network",
  platformTagline: "Vietnam's leading genuine-parts platform",
  platformDesc: "Manage your auto-parts supply chain end to end.",
  copyright: "(c) 2024 AutoParts. Professional parts distribution system.",
  // Mechanic sidebar
  mechanicDashboard: "Overview", mechanicOrder: "Order parts",
  mechanicServices: "Repair services", mechanicPoints: "Mechanic points",
  mechanicProfile: "Profile", mechanicSettings: "Settings",
  // Address Book
  addressBook: "Address book", addAddress: "Add address", editAddress: "Edit address",
  deleteAddress: "Delete address", setDefault: "Set as default", defaultAddress: "Default address",
  recipientName: "Recipient name", recipientPhone: "Recipient phone",
  noAddresses: "No addresses yet", confirmDeleteAddress: "Delete this address?",
  // Wishlist
  wishlist: "Wishlist", wishlistEmpty: "Your wishlist is empty",
  removeFromWishlist: "Remove from wishlist", addedToWishlist: "Added to wishlist",
  // Reviews
  writeReview: "Write a review", reviewTitle: "Review title", reviewContent: "Review content",
  submitReview: "Submit review", reviewPending: "Pending", reviewApproved: "Approved",
  reviewRejected: "Rejected", customerReviews: "My reviews", reviewsSection: "Customer reviews",
  // Returns / RMA
  myReturns: "Returns", createReturn: "Create return request", returnReason: "Return reason",
  returnStatus: "Status", returnPending: "Processing", returnApproved: "Approved",
  returnRejected: "Rejected", returnOrderId: "Order ID", returnDescription: "Problem description",
  returnImages: "Proof images", submitReturn: "Submit request",
  // Admin Inventory
  inventoryManage: "Inventory management", stockAdjust: "Adjust stock",
  stockHistory: "Stock history", lowStockAlert: "Low stock alert", totalProducts: "Total products",
 },
 zh: {
  // Nav
  ...
  tier1Price: "一级代理价", discount17: "立减17%", returns: "退换货", delivery: "配送", "7days": "7天", "2_4days": "2-4天", remaining: "剩余", items: "件",
  genericParts: "通用零件",
  // Admin sidebar
  adminDashboard: "控制台", adminUsers: "合作伙伴与客户",
  adminCatalog: "产品与分类", adminOrders: "订单",
  ...
  adminSuppliers: "供应商", adminMessages: "消息", adminVehicles: "车型与VIN",
  adminCms: "内容管理", adminSynonyms: "同义词", adminImportExport: "导入 / 导出",
  adminNewsletter: "邮件通讯", adminAttributeSets: "属性集", adminInvoices: "发票",
  adminTransactions: "交易", adminRefunds: "退款", adminCarriers: "物流",
  adminTaxRates: "税率", adminWarehouses: "仓库与货源", adminChannels: "销售渠道",
  adminProfile: "个人资料", adminSuspensions: "暂停申请",
  accountProfileTitle: "账户资料", saveChanges: "保存更改", savedShort: "✓ 已保存！",
  basicInfo: "基本信息", roleLabel: "权限",
  distributionChannel: "主要分销渠道", selfIntro: "个人简介",
  txTypePayment: "支付", txTypeRefund: "退款", txTypeAdjustment: "调整",
  txMethodQr: "扫码转账", txMethodCod: "货到付款 (COD)", txMethodMomo: "MoMo 钱包",
  txMethodBank: "银行转账", txMethodCard: "银行卡",
  txStatusPending: "处理中", txStatusSuccess: "成功", txStatusFailed: "失败",
  txStatusCancelled: "已取消", txStatusRefunded: "已退款",
  txAllTypes: "所有类型", txLoading: "加载中...", txEmpty: "暂无交易",
  txEmptyHint: "创建订单时将自动记录交易。",
  txColOrder: "订单", txColType: "类型", txColMethod: "方式", txColAmount: "金额",
  txColStatus: "状态", txColTime: "时间",
  // Admin content
  ...
  trackOrder: "查询订单",
  home: "首页", specs: "技术参数", origin: "产地", stockStatus: "库存状态", originalOEM: "原厂 OEM", itemsAvailable: "件可用", reviewsTab: "评价", notUpdated: "未更新", noReviewsYet: "暂无评价",
  allProducts: "全部产品", aftermarketOES: "副厂 / OES", verifiedBuyer: "已验证买家", compatibleWithFollowing: "适配以下车型", loadingProductInfo: "正在加载产品信息...", "2_4days": "2–4天", "7days": "7天", favorite: "收藏", share: "分享",
  analyticsAndReports: "分析与报告", analyticsDesc: "营收、产品和客户统计", exportReport: "导出报告", revenueByDay: "每日营收", top5SellingProducts: "畅销产品 Top 5", conversionRate6Months: "6个月转化率", byCategory: "按分类", averageRating: "平均评分", successfulOrders: "成功订单", ordersCount: "订单数", vsLastMonth: "环比上月", stable: "稳定",
  noOrders: "暂无订单", orderCode: "订单号", orderPending: "待确认", orderConfirmed: "已确认", orderShipping: "配送中", orderDelivered: "已送达", confirmDelivered: "确认已送达", confirmStockIn: "确认入库", stockInQty: "入库数量", statusUpdated: "状态已更新", updateFailed: "更新失败",
  trackOrderDesc: "输入订单号查看配送状态和收货信息。",
  enterOrderCodeToTrack: "在上方输入订单号以查看配送进度。",
...
export function LangProvider({ children }: { children: ReactNode }) {
 ...
 useEffect(() => {
  ...
  const next = saved === "vi" || saved === "en" || saved === "zh" ? saved : "vi";
  setLangState(next);
  document.documentElement.lang = next === "en" ? "en" : next === "zh" ? "zh-CN" : "vi";
 }, []);

 const setLang = (l: Lang) => {
  setLangState(l);
  localStorage.setItem("lang", l);
  document.documentElement.lang = l === "en" ? "en" : l === "zh" ? "zh-CN" : "vi";
 };

 // Fallback to vi if en translation is missing
