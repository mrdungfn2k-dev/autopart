...
export default function AdminSidebar({
 active }: { active?: string }) {
  ...
  const cur = active || pathname || "/admin";
  ...
  const menuItems = [
    ...
    { label: t("groupManage"), section: true },
    ...
    { label: t("groupOperations"), section: true },
    ...
    { label: t("adminSuspensions"), href: "/admin/suspensions",
    ...
    { label: t("adminImportExport"), href: "/admin/import-export",
    ...
    { label: t("adminNewsletter"), href: "/admin/newsletter",
      icon: "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" },
    { label: t("adminAttributeSets"), href: "/admin/attribute-sets",
      icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
    { label: t("adminInvoices"), href: "/admin/invoices",
      icon: "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm0 7V3.5L18.5 9H14z" },
    { label: t("adminTransactions"), href: "/admin/transactions",
      icon: "M21 7H3V5h18v2zm0 5H3v-2h18v2zm-6 5H3v-2h12v2z" },
    { label: t("adminRefunds"), href: "/admin/refunds",
      icon: "M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 16.03 20 14.57 20 13c0-4.42-3.58-8-8-8z" },
    { label: t("adminCarriers"), href: "/admin/carriers",
      icon: "M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2a3 3 0 003 3 3 3 0 003-3h6a3 3 0 003 3 3 3 0 003-3h2v-5l-3-4z" },
    { label: t("adminTaxRates"), href: "/admin/tax-rates",
      icon: "M19 5v2H5V5h14m0-2H5c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2V5c0-1.11-.89-2-2-2zm0 14H5v-2h14v2zm0-4H5V9h14v6z" },
    { label: t("adminWarehouses"), href: "/admin/warehouses",
      icon: "M22 21V7L12 3 2 7v14h5v-9h10v9h5z" },
    { label: t("adminChannels"), href: "/admin/channels",
      icon: "M12 22a10 10 0 010-20 10 10 0 010 20zm-1-3.06v-4.04l-7.86-1.98c.79 3.42 3.85 5.69 7.86 6.02zM3 12c0 .57.06 1.13.16 1.66L11 14.94v-3.94L3 12z" },
    { label: t("adminProfile"), href: "/admin/profile", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
];
    ...
    <aside className="w-[220px] shrink-0 min-h-screen flex flex-col" style={{ background: "var(--ap-sidebar-bg)" }}>
      ...
      <nav className="flex-1 p-4 space-y-0.5 overflow-auto" ref={(el) => { if (!el) return; const s = sessionStorage.getItem("ap-sidebar-scroll"); if (s) el.scrollTop = +s; el.onscroll = () => sessionStorage.setItem("ap-sidebar-scroll", String(el.scrollTop)); }}>
        {menuItems.map((item, i) => {
          ...
          const isActive = item.href === cur || (item.href !== "/admin" && cur.startsWith(item.href || " "));
