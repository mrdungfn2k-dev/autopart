...
export default function CurrencySwitcher() {
  ...
  useEffect(() => {
    ...
    // Tỉ giá thật cập nhật theo ngày (VND / USD / CNY)
    const fallback: Currency[] = [
      { code: "VND", symbol: "₫", rate: 1 },
      { code: "USD", symbol: "$", rate: 25400 },
      { code: "CNY", symbol: "¥", rate: 3500 },
    ];
    fetch("/api/exchange-rates")
      ...
      .then(d => {
        ...
        setSupported([
          { code: "VND", symbol: "₫", rate: 1 },
          { code: "USD", symbol: "$", rate: rt.USD || 25400 },
          { code: "CNY", symbol: "¥", rate: rt.CNY || 3500 },
        ]);
      })
      .catch(() => setSupported(fallback));
  }, []);
